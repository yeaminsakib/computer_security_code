...
def generate_playfair_matrix(key):
    ...
    # Initialize the matrix with 'X'e
...
def encrypt_playfair(plaintext, key):
    ...
    while i < len(plaintext) - 1:
        ...
        i += 2
    print('Add x when 2 letter is same:',plaintext)
...
# Call the function to print the matrix after filling it with the key
#key_input = input("Enter the key to generate the Playfair matrix: ")
#print("\nGenerated Playfair matrix:")
#generate_playfair_matrix(key_input)
